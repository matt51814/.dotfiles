...
() {
  ...
  typeset -g __p9k_instant_prompt_param_sig=$'\'\'\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-AApple_Terminal\C-A63\C-Amatthawthorn%\C-A\C-A\C-A\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A1\C-AUTF-8\C-A\C-A\C-A0\C-A1\C-A/Users/matthawthorn/.antigen/bundles/romkatv/powerlevel10k\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-A\C-A3\C-Ad h m s\C-A0\C-A5\C-A/Users/matthawthorn/.p10k.zsh\C-A\C-A%F{7}%n%f%F{242}@%m%f\C-A\C-A%F{242}%n@%m%f\C-A4\C-Atrue\C-Averbose\C-A\C-Acontext\C-Bdir\C-Bvcs\C-Bcommand_execution_time\C-Bvirtualenv\C-Bprompt_char\C-A\C-A\C-A \C-Afalse\C-A❮\C-A1\C-A❯\C-A1\C-A❮\C-A1\C-A❮\C-A5\C-A❯\C-A5\C-A❮\C-A5\C-Afalse\C-A\C-Atime\C-A\C-A\C-A \C-A242\C-A%D{%I:%M:%S %p}\C-Afalse\C-Aoff\C-A\C-A1\C-A1\C-A@\C-A${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }\C-A*\C-A242\C-Avcs-detect-changes\C-Bgit-untracked\C-Bgit-aheadbehind\C-A6\C-A:⇣\C-A\C-A0\C-A6\C-A:⇡\C-A\C-A\C-A\C-A242\C-A\C-A\C-Afalse\C-A'
  local gitstatus_dir=/Users/matthawthorn/.antigen/bundles/romkatv/powerlevel10k/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/Users/matthawthorn/.cache/p10k-matthawthorn
  ...
  local -A _p9k_display_k=(-1/left/virtualenv 25 1/left/command_execution_time 23 1/left/dir 19 empty_line 1 1/left/prompt_char 27 1/gap 15 -1/left 11 -1/left/prompt_char 27 -1 5 1/left 11 -1/left/dir 19 -1/gap 15 -1/right_frame 9 1/right_frame 9 -1/left/command_execution_time 23 1/left/vcs 21 1/right 13 1/right/time 29 -1/right/time 29 -1/right 13 1/left/context 17 -1/left/context 17 1/left/virtualenv 25 -1/left/vcs 21 1/left_frame 7 1 5 -1/left_frame 7 ruler 3)
  local -a _p9k__display_v=(empty_line hide ruler hide 1 show 1/left_frame show 1/right_frame show 1/left show 1/right show 1/gap show 1/left/context show 1/left/dir show 1/left/vcs show 1/left/command_execution_time show 1/left/virtualenv show 1/left/prompt_char show 1/right/time show)
  function p10k() {
    emulate -L zsh -o no_hist_expand -o extended_glob -o no_prompt_bang -o prompt_percent -o no_prompt_subst -o no_aliases -o no_bg_nice -o typeset_silent -o no_rematch_pcre
  (( $+__p9k_trapped )) || { local -i __p9k_trapped; trap : INT; trap "trap ${(q)__p9k_trapint:--} INT" EXIT }
  local -a match reply mbegin mend
